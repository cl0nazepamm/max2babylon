...
namespace Max2Babylon
{
    public partial class MultiExportForm : Form
    {
        ...
        private FolderBrowserDialog setTexturesFolderDialog;
        ...
        private void ShowTexturesFolderDialog(List<DataGridViewCell> pathCells)
        {
           ...
           string intialDirectory = pathCells[0].Value as string;
            ...
            setTexturesFolderDialog = new FolderBrowserDialog()
            {
                InitialDirectory = intialDirectory,
                ShowNewFolderButton = true,
                Description = "Select Texture folder. This will be used as output folder for textures of exported item"
            };

            if (setTexturesFolderDialog.ShowDialog(this) == DialogResult.OK)
            {
                string selectedFolder = setTexturesFolderDialog.SelectedPath;
            ...
            setTexturesFolderDialog.Dispose();
